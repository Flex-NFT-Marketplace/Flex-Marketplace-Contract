...
fn test_make_collection_offer() {
    ...
    test.erc6105.make_collection_offer(amount,
        sale_price,
        expires,
        zero_address
    );
            ...
            (
                ...
                ERC6105CollectionOfferComponent::Event::UpdateCollectionOffer(
                    ERC6105CollectionOfferComponent::UpdateCollectionOffer {
                        from: eth_rich_address, amount, sale_price, expires, supported_token: zero_address
                    }
            )
            )
        ]
...
fn test_accept_collection_offer_with_benchmark() {
    ...
    start_cheat_caller_address(test.erc6105_address, OWNER());
    test.erc6105.accept_collection_offer_with_benchmark(token_id, sale_price, zero_address, eth_rich_address, 0);
    ...
    spy.assert_emitted(
        @array![
            (
                ...
                ERC6105CollectionOfferComponent::Event::UpdateCollectionOffer(
                    ERC6105CollectionOfferComponent::UpdateCollectionOffer {
                        from: eth_rich_address, amount: 0, sale_price: 0, expires: 0, supported_token: zero_address
                    }
                )
            )
        ]
...
fn test_get_collection_offer() {
    ...
    let (res_amount, res_sale_price, res_expires, res_supported_token): (u256, u256, u64, ContractAddress) = test.erc6105.get_collection_offer(eth_rich_address);
