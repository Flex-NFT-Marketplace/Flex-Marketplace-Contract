// console.log("\n📦 Deploying FILL...")
//     const compiledFILLCasm = json.parse(fs.readFileSync("../target/dev/flex_FILL.compiled_contract_class.json").toString("ascii"))
//     const compiledFILLSierra = json.parse(fs.readFileSync("../target/dev/flex_FILL.contract_class.json").toString("ascii"))
//     const fillCallData: CallData = new CallData(compiledFILLSierra.abi)
//     const fillConstructor: Calldata = fillCallData.compile("constructor", { fee_registry: 0, owner: account0.address })
//     const deployFILLResponse = await account0.declareAndDeploy({
//         contract: compiledFILLSierra,
//         casm: compiledFILLCasm,
//         constructorCalldata: fillConstructor
//     })
//     console.log("✅ FILL Deployed: ", deployFILLResponse.deploy.contract_address)
