...
async function deploy() {
    ...
    const transferSelectorNFTConstructor: Calldata = transferSelectorNFTCallData.compile("constructor", { transfer_manager_ERC721: deployTransferManagerNFTResponse.deploy.contract_address, transfer_manager_ERC1155: deployTransferManagerNFTResponse.deploy.contract_address, owner: account0.address })
